...
vim.cmd("set ai")               -- always set autoindenting on
vim.cmd("set si")               -- smart indent
vim.cmd("set viminfo='20,\"50") -- read/write a .viminfo file, don't store more than 50 lines of registers
...
vim.cmd("set wildmenu")         -- display completion matches in a status line
...
vim.cmd("nnoremap <leader>pv :Explore<CR>")

-- disable Q (evil)
vim.cmd("noremap Q <nop>")

-- J at the beginning of the line
vim.cmd("noremap J mjJ'j")

-- move selected lines when in visual mode (countable!!!)
vim.cmd([[vnoremap <expr> <C-J> ":m .+" . v:count1 . "<CR>gv=gv"]])
vim.cmd([[vnoremap <expr> <C-K> ":m .-" . (v:count1 + 1) . "<CR>gv=gv"]])

-- Perl substitution
vim.cmd([[noremap S :%s//g<left><left>]])
...
-- change to void
vim.cmd([[noremap <leader>c "_c]])
vim.cmd([[nnoremap <leader>C "_C]])

-- delete to void
vim.cmd([[noremap <leader>d "_d]])
...
vim.cmd([[noremap zq 1z=]])
vim.cmd([[inoremap <C-L> <Esc>[s1z=`]a]])

-- comment lines
vim.cmd([[nnoremap çç mpI//<Esc>mp]])
vim.cmd([[nnoremap Ç mpi//<Esc>mp]])
vim.cmd([[vnoremap ç mp<Esc>`>a*/<Esc>`<i/*<Esc>mp]])

-- make current file executable
vim.cmd([[nnoremap <silent> <leader>x :!chmod +x %<CR><CR>]])
...
-- CRLF to LF
vim.cmd([[noremap <leader>ml :e ++ff=unix<CR>:%s/\r//g<CR>]])

-- delete trailing white space
vim.cmd([[command! Trim :%s/\s\+$//gm]])
vim.cmd([[noremap <leader>mt :Trim<CR>]])

-- convert tabs to spaces (needs some fixing)
vim.cmd([[command! TabsToSpaces :%s/\t/    /gm]])
vim.cmd([[noremap <leader>ms :TabsToSpaces<CR>]])
...
vim.cmd([[autocmd FileType xml  setlocal shiftwidth=2]])
vim.cmd([[autocmd FileType html setlocal shiftwidth=2]])
vim.cmd([[autocmd FileType pug  setlocal shiftwidth=2]])


-- toggle wrap
vim.cmd([[noremap <leader>mw :set wrap!<CR>]])

-- move tabs
vim.cmd([[noremap <F9>  :tabm -1<CR>]])
vim.cmd([[noremap <F10> :tabm +1<CR>]])

-- new tab
vim.cmd([[nnoremap <leader>tn :tabnew<CR>]])

-- new vsplit
vim.cmd([[nnoremap <leader>vn :vert new<CR>]])

-- new vsplit
vim.cmd([[nnoremap <leader>w :w<CR>]])


vim.cmd([[command! DiffOrig vert new | set bt=nofile | r ++edit # | 0d_ | diffthis
        \ | wincmd p | diffthis
